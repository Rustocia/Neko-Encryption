...
public:
	template < size_t... Is >
	constexpr __forceinline Neko(const char* str, std::index_sequence< Is... >) : _key(RandomChar< K >::value), _encrypted{ enc(str[Is])... } {
	}
...
#define Neko( s ) ( sartaCompileTime::Neko< sizeof( s ) - 1, __COUNTER__ >( s, std::make_index_sequence< sizeof( s ) - 1>() ).decrypt() )
END_NAMESPACE
//-----------------------------------------------------
